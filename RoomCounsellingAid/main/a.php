        ...
        <div class="modal-content">
			...
			<?php 
				...
				if (isset ($_POST ['save'])){
					...
					$conn->query("INSERT INTO campaign(firstname,lastname,year_level,group,block,roomtype,acnonac,rank,need,img)values('$firstname','$lastname','$year_level','$group','$block','$roomtype','$acnonac','$rank','$need','$location')")or die(mysql_error());
				}						
			?>					
        </div>
