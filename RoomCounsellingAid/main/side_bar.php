<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0; background-color:#0022ff;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style = "color:white;"><i class = "fa fa-home fa-large" > </i>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-users fa-fw"></i>Campaign<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="add_campaign.php"><i class = "fa fa-user fa-fw"></i> Start Campaign</a>
                                </li>
                                <li>
                                    <a href="candidate.php"><i class = "fa fa-user fa-fw"></i> View Campaign </a>
                                </li>
